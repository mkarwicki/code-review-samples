...
class CompanyNewContractNotificationService {
	private $notificationType = 'company-new-contract';
	...
	public function sendNotificationEmail(Notifications $notification){
		$this->notificationsEmail->setName('New contract draft '.$notification->getContract()->getContractID().' ('.$notification->getJobs()->getTitle().')');
		$this->notificationsEmail->setBody(
			$this->twig->render( 'email_templates/notifications_email/company/company_new_contract.html.twig',
				[
