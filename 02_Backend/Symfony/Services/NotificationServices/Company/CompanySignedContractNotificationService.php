...
class CompanySignedContractNotificationService {
	private $notificationType = 'company-signed-contract';
	...
	public function sendNotificationEmail(Notifications $notification){
		$this->notificationsEmail->setName('Contract '.$notification->getContract()->getContractID().' ('.$notification->getJobs()->getTitle().') signed by freelancer');
		$this->notificationsEmail->setBody(
			$this->twig->render( 'email_templates/notifications_email/company/company_signed_contract.html.twig',
				[
